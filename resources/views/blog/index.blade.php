    ...
    <div class="info">
        <div>
            <div class="container">
                    ...
                    <h1 class="h1">Placeholder Title</h1>
        ...
        <article class="news-one">
            ...
            <div class="description">
                ...
                <div class="align-center">
                    <a href="assets/images/dark/game-kingdoms-of-amalur-reckoning-1440x900.jpg" class="angled-img image-popup">
                        <div class="img">
                ...
                <div class="align-center">
                    <!--
                        ...
                        Additional attributes:
                            ...
                            data-item-padding
                    -->
                    <div class="youplay-carousel youplay-carousel-size-1 youplay-slider gallery-popup" data-stage-padding="0" data-dots="true" data-arrows="false">
                        <a href="assets/images/dark/game-kingdoms-of-amalur-reckoning-2-1940x1185.jpg" class="angled-img">
                            <div class="img">
                                <img src="assets/images/dark/game-kingdoms-of-amalur-reckoning-2-500x375.jpg" alt="">
                            </div>
                            <i class="fa fa-search-plus icon"></i>
                        </a>
                        <a href="assets/images/dark/game-kingdoms-of-amalur-reckoning-3-1920x1080.jpg" class="angled-img">
                            <div class="img">
                                <img src="assets/images/dark/game-kingdoms-of-amalur-reckoning-3-500x375.jpg" alt="">
                            </div>
                            <i class="fa fa-search-plus icon"></i>
                        </a>
                    </div>
                ...
                <div class="align-center">
                    <a href="assets/images/dark/game-kingdoms-of-amalur-reckoning-4-1920x1080.jpg" class="angled-img image-popup mr-0">
                        <div class="img">
                            <img src="assets/images/dark/game-kingdoms-of-amalur-reckoning-4-500x375.jpg" alt="">
                        </div>
                        <i class="fa fa-search-plus icon"></i>
                    </a>
                    <a href="assets/images/dark/game-kingdoms-of-amalur-reckoning-5-1280x800.jpg" class="angled-img image-popup">
                        <div class="img">
                            <img src="assets/images/dark/game-kingdoms-of-amalur-reckoning-5-500x375.jpg" alt="">
                        </div>
                        <i class="fa fa-search-plus icon"></i>
                    </a>
                </div>
            ...
            <div class="youplay-review-rating">
                <div class="row">
                    <div class="col-md-4">
                        <div class="youplay-hexagon-rating" data-max="10" title="3.8 out of 10"><span>3.8</span></div>
                    </div>
                    <div class="col-md-4">
                        <h3 class="mt-0">Good</h3>
                        <ul>
                            <li><i class="fa fa-plus-circle"></i> Impressive story</li>
                            <li><i class="fa fa-plus-circle"></i> Beautiful environments and solid animations</li>
                            <li><i class="fa fa-plus-circle"></i> Absolute cool gameplay</li>
                            <li><i class="fa fa-plus-circle"></i> Lasting appeal</li>
                        </ul>
                    </div>
                    <div class="col-md-4">
                        <h3 class="mt-0">Bad</h3>
                        <ul>
                            <li><i class="fa fa-minus-circle"></i> Bad rating delivered for demonstration purposes only. Really cool game.</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <li>
                    <article>
                        <div class="comment-avatar pull-left">
                            <img src="assets/images/dark/avatar-user-2.png" alt="">
                        </div>
                    ...
                    <ul class="child-comment">
                        ...
                        <li>
                            <article>
                                <div class="comment-avatar pull-left">
                                    <img src="assets/images/dark/avatar-user-3.png" alt="">
                                </div>
                                <div class="comment-cont clearfix">
                            ...
                            <ul class="child-comment">
                                ...
                                <li>
                                    <article>
                                        <div class="comment-avatar pull-left">
                                            <img src="assets/images/dark/avatar-user-4.png" alt="">
                                        </div>
                                        <div class="comment-cont clearfix">
